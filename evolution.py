...
class Evolution:
    ...
    def __init__(self, problem, node_num, num_of_generations=60, num_of_individuals=100, num_of_tour_particips=2,
    ...
    def evolve(self):
        ...
        first_population=[[i.objectives[0],i.objectives[1],i.positive_nodes] for i in self.population]
        # first_population_fronts=[[i.objectives[0],i.objectives[1]] for i in self.population.fronts[0]]
        # first_population_1=[[i.objectives[0],i.objectives[1]] for i in self.population]
        # print('first_population:', first_population)
        # print('first_population_1:', first_population_1)
        # print('first_population_fronts:', first_population_fronts)
        ...
        # solutions_dict[0] = [[i.objectives[0],i.objectives[1],i.positive_nodes] for i in self.population.fronts[0]]
        # population_dict[0]=[[i.objectives[0],i.objectives[1],i.positive_nodes] for i in self.population]
        ...
        for i in t:
            ...
            front_percent.append(len(self.population.fronts[0]) / self.num_of_individuals)
            solutions_dict[i]=[[i.objectives[0],i.objectives[1],i.positive_nodes] for i in self.population.fronts[0]]
            population_dict[i]=[[i.objectives[0],i.objectives[1],i.positive_nodes] for i in self.population]
        ...
        ax.set_title('Avg Cost in Whole Population', fontsize=20)
        ...
        ax.set_title('Avg Cost in Front 0', fontsize=20)
